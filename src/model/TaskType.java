...
public enum TaskType {
    ...
    public static TaskType getTaskType(String taskType) {
        ...
        return switch (taskType) {
            ...
            case "Customer Deactivation" -> CUSTOMER_REMOVAL;
            case "Vehicle Deactivation" -> VEHICLE_REMOVAL;
            case "Insurance Deactivation" -> INSURANCE_REMOVAL;
            case "Ticket Deactivation" -> TICKET_REMOVAL;
            case "Employee Deactivation" -> EMPLOYEE_REMOVAL;
    ...
    public static String getDescription(TaskType taskType) {
        return switch (taskType) {
            ...
            case CUSTOMER_REMOVAL -> "Customer Deactivation";
            case VEHICLE_REMOVAL -> "Vehicle Deactivation";
            case INSURANCE_REMOVAL -> "Insurance Deactivation";
            case TICKET_REMOVAL -> "Ticket Deactivation";
            case EMPLOYEE_REMOVAL -> "Employee Deactivation";
