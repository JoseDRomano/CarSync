...
public class Encryptor {
    ...
    public static String encryptSHA256WithCatch(String input)  {
        StringBuilder hexString = new StringBuilder(input);
        try {
            MessageDigest md = MessageDigest.getInstance("SHA-256");
            byte[] hashBytes = md.digest(input.getBytes(StandardCharsets.UTF_8));
            ...
            System.out.println("SHA-256 algorithm not available, encripton failed.");
            e.printStackTrace();
